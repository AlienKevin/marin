...
Across all **1,610** sampled generations (46 stratified trials × 7 checkpoints × 5 draws), **25.3% degenerate**, where "degenerate" = long (> 800 chars) *and* highly compressible (zlib ratio < 0.08, i.e. almost entirely repeated content).
